...
try {
  ...
  assert.deepEqual(magokState, { h1: "마곡 답례품·쿠키 선물을 찾고 있다면공항동에서 만들어 가까이 전해드려요", cards: 6, favorGuide: 3, corporate: true, pickup: true, kakao: true, faq: 6, quickNav: true, floats: 2, address: true, locationContext: true }, "magok cookie hub should expose the local ordering path");
